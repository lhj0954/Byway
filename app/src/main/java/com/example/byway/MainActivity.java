...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void setupUI() {
        ...
        bottomNavigationView.getMenu().setGroupCheckable(0, true, false); // 선택 가능 해제
        for (int i = 0; i < bottomNavigationView.getMenu().size(); i++) {
            bottomNavigationView.getMenu().getItem(i).setChecked(false);  // 모두 선택 해제
        }
        bottomNavigationView.getMenu().setGroupCheckable(0, true, true);  // 다시 활성
